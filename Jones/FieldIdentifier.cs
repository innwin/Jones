...
namespace Jones
{
  ...
  public readonly struct FieldIdentifier : IEquatable<FieldIdentifier>
  {
    ...
    {
      Expression expression1 = accessor.Body;
      ...
      {
        model = expression2.Value != null ? expression2.Value : throw new ArgumentException("The provided expression must evaluate to a non-null value.");
      }
      else
      {
